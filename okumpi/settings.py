...
Django 5.x / 6.x compatible. SQLite database, no external
...
# SECURITY WARNING: replace this key and turn DEBUG off in production.
SECRET_KEY = 'django-insecure-okumpi-v2-dev-key-change-me-in-production'
DEBUG = True
ALLOWED_HOSTS = ['*']
